  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike and call the wheelie method on the selected motorbike. If the selected vehicle is not a motorbike, log that only motorbikes can perform a wheelie.
